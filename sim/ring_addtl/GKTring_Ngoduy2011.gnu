...
set out "GKTring_Ngoduy2011.rho3d.png"
print "plotting GKTring_Ngoduy2011.rho3d.png"
...
splot "GKTring_Ngoduy2011.dat" u ($1-xc):($2):3 w l lt 2

set out "GKTring_Ngoduy2011.v3d.png"
print "plotting GKTring_Ngoduy2011.v3d.png"
set zlabel "V(km/h)" offset 0,2
splot "GKTring_Ngoduy2011.dat" u ($1-xc):($2):4 w l lt 2

##################################################

set size 1,1
set grid
set out "GKTring_Ngoduy2011.Qe.png"
print "plotting GKTring_Ngoduy2011.Qe.png"
...
plot\
  "GKTring_Ngoduy2011.tab"   u 1:4 t "Equilibrium flow"  w l ls 2
...
set out "GKTring_Ngoduy2011.tseriesUpDown.png"
...
plot[t=0:1]\
  "GKTring_Ngoduy2011.x12000"  u ($2-60):4 t "10 km upstream  " w l ls 1,\
  "GKTring_Ngoduy2011.x21000" u ($2-60):4 t "1 km upstream   " w l ls 2,\
  "GKTring_Ngoduy2011.x23000" u ($2-60):4 t "1 km downstream " w l ls 3,\
  "GKTring_Ngoduy2011.x25000" u ($2-60):4 t "3 km downstream " w l ls 3,\
  0, 110*t t "begin/end of obstruction" w l ls 10,\
  30, 110*t t "" w l ls 10

set out "GKTring_Ngoduy2011.tseriesUp.png"
plot[t=0:1]\
  "GKTring_Ngoduy2011.x21000" u ($2-60):4 t " 1 km upstream " w l ls 1,\
  "GKTring_Ngoduy2011.x19000"  u ($2-60):4 t " 3 km upstream " w l ls 2,\
  "GKTring_Ngoduy2011.x17000"  u ($2-60):4 t " 5 km upstream " w l ls 3,\
  "GKTring_Ngoduy2011.x12000"  u ($2-60):4 t "10 km upstream " w l ls 5,\
  0, 110*t t "begin/end of obstruction" w l ls 10,\
  30, 110*t t "" w l ls 10

set auto y
set out "GKTring_Ngoduy2011.aUp.png"

plot\
  "GKTring_Ngoduy2011.x12000" u ($2-60):6 t "10 km upstream  " w l ls 1,\
  "GKTring_Ngoduy2011.x21000" u ($2-60):6 t "1 km upstream   " w l ls 2,\
  "GKTring_Ngoduy2011.x23000" u ($2-60):6 t "1 km downstream " w l ls 3,\
  "GKTring_Ngoduy2011.x25000" u ($2-60):6 t "3 km downstream " w l ls 4

set auto y
set out "tmp.png"

plot\
  "GKTring_Ngoduy2011.x12000"  u ($2-60):5 t "10 km upstream  " w l ls 1,\
  "GKTring_Ngoduy2011.x21000" u ($2-60):5 t "1 km upstream   " w l ls 2,\
  "GKTring_Ngoduy2011.x23000" u ($2-60):5 t "1 km downstream " w l ls 3,\
  "GKTring_Ngoduy2011.x25000" u ($2-60):5 t "3 km downstream " w l ls 4
...
set out "GKTring_Ngoduy2011.Qrho.png"
...
plot\
  "GKTring_Ngoduy2011.x19000"  u (rho($3,$2)):(Q($5,$2)) t "3 km upstream " w l ls 5,\
  "GKTring_Ngoduy2011.tab"   u 1:4 t "Equilibrium flow"  w l ls 11
