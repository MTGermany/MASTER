...
##################################################
set out "GKTtype2b-PLC.rho3d.png"
print "plotting GKTtype2b-PLC.rho3d.png ..."
...
splot "GKTtype2b-PLC.dat" u 2:1:3 w l lt 2

##################################################
set out "GKTtype2b-PLC.v3d.png"
#set title "V (km/h)"
#set zlabel "V (km/h)"
set label 1 "V (km/h)" at screen 1.73,1.62
set cbrange [0:100]

print "plotting GKTtype2b-PLC.v3d.png ..."

splot "GKTtype2b-PLC.dat" u 2:1:4 w l lt 2

##################################################
#set out "GKTtype2b-PLC.Q3d.png"
#set zrange [1500:]
#set zlabel "Flow (veh/h/lane)" offset 0,2
#splot "GKTtype2b-PLC.dat" u ($1-15):2:5 w l lt 2

##################################################

####################################
set term png enhanced font Helvetica 14 xffffff
set out "GKTtype2b-PLC_fund.png"
print "plotting GKTtype2b-PLC_fund.png ..."
set size 0.85,1
...
plot[t=0:1]\
 "GKTtype2b-PLC.tab" u 1:4 t "" w l ls 1,\
...
set out "GKTtype2b-PLC.tseriesUpDown.png"
...
plot[t=0:1]\
  "GKTtype2b-PLC.x12000"  u ($2-60):4 t "10 km upstream  " w l ls 1,\
  "GKTtype2b-PLC.x21000" u ($2-60):4 t "1 km upstream   " w l ls 2,\
  "GKTtype2b-PLC.x23000" u ($2-60):4 t "1 km downstream " w l ls 3,\
  "GKTtype2b-PLC.x25000" u ($2-60):4 t "3 km downstream " w l ls 3,\
  0, 110*t t "begin/end of obstruction" w l ls 10,\
  30, 110*t t "" w l ls 10

set out "GKTtype2b-PLC.tseriesUp.png"
plot[t=0:1]\
  "GKTtype2b-PLC.x21000" u ($2-60):4 t " 1 km upstream " w l ls 1,\
  "GKTtype2b-PLC.x19000"  u ($2-60):4 t " 3 km upstream " w l ls 2,\
  "GKTtype2b-PLC.x17000"  u ($2-60):4 t " 5 km upstream " w l ls 3,\
  "GKTtype2b-PLC.x12000"  u ($2-60):4 t "10 km upstream " w l ls 5,\
  0, 110*t t "begin/end of obstruction" w l ls 10,\
  30, 110*t t "" w l ls 10

set auto y
set out "GKTtype2b-PLC.aUp.png"

plot\
  "GKTtype2b-PLC.x12000" u ($2-60):6 t "10 km upstream  " w l ls 1,\
  "GKTtype2b-PLC.x21000" u ($2-60):6 t "1 km upstream   " w l ls 2,\
  "GKTtype2b-PLC.x23000" u ($2-60):6 t "1 km downstream " w l ls 3,\
  "GKTtype2b-PLC.x25000" u ($2-60):6 t "3 km downstream " w l ls 4

set auto y
set out "tmp.png"

plot\
  "GKTtype2b-PLC.x12000"  u ($2-60):5 t "10 km upstream  " w l ls 1,\
  "GKTtype2b-PLC.x21000" u ($2-60):5 t "1 km upstream   " w l ls 2,\
  "GKTtype2b-PLC.x23000" u ($2-60):5 t "1 km downstream " w l ls 3,\
  "GKTtype2b-PLC.x25000" u ($2-60):5 t "3 km downstream " w l ls 4
...
set out "GKTtype2b-PLC.Qrho.png"
...
plot\
  "GKTtype2b-PLC.x19000"  u (rho($3,$2)):(Q($5,$2)) t "3 km upstream " w l ls 5,\
  "GKTtype2b-PLC.tab"   u 1:4 t "Equilibrium flow"  w l ls 11
