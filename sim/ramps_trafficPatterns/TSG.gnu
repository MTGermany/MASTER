...
##################################################
set out "TSG.rho3d.png"
print "plotting TSG.rho3d.png ..."
...
splot "TSG.dat" u 1:($2):3 w l lt 2
...
print "plotting TSG.v3d.png ..."

splot "TSG.dat" u 1:($2):4 w l lt 2

##################################################
#set out "TSG.Q3d.png"
#set zrange [1500:]
#set zlabel "Flow (veh/h/lane)" offset 0,2
#splot "TSG.dat" u ($1-15):2:5 w l lt 2

##################################################

####################################
set term png enhanced font Helvetica 14 xffffff
set out "TSG_fund.png"
print "plotting TSG_fund.png ..."
set size 1,1
...
plot[t=0:1]\
 "TSG.tab" u 1:4 t "" w l ls 1,\
 rhoc1, t*Qc1 t "Limit {/Symbol r}_{c1}" w l ls 2,\
 rhoc2, t*Qc2 t "Limit {/Symbol r}_{c2}" w l ls 3,\
 rhocconv, t*Qcconv t "Limit {/Symbol r}_{conv}" w l lt 0,\
 rhoc3, t*Qc3 t "Limit {/Symbol r}_{c3}" w l ls 3,\
 rhoc4, t*Qc4 t "Limit {/Symbol r}_{c4}" w l ls 2
...
plot[t=0:1]\
  "TSG.x12000"  u ($2-60):4 t "10 km upstream  " w l ls 1,\
  "TSG.x21000" u ($2-60):4 t "1 km upstream   " w l ls 2,\
  "TSG.x23000" u ($2-60):4 t "1 km downstream " w l ls 3,\
  "TSG.x25000" u ($2-60):4 t "3 km downstream " w l ls 3,\
  0, 110*t t "begin/end of obstruction" w l ls 10,\
  30, 110*t t "" w l ls 10

set out "TSG.tseriesUp.png"
plot[t=0:1]\
  "TSG.x21000" u ($2-60):4 t " 1 km upstream " w l ls 1,\
  "TSG.x19000"  u ($2-60):4 t " 3 km upstream " w l ls 2,\
  "TSG.x17000"  u ($2-60):4 t " 5 km upstream " w l ls 3,\
  "TSG.x12000"  u ($2-60):4 t "10 km upstream " w l ls 5,\
  0, 110*t t "begin/end of obstruction" w l ls 10,\
  30, 110*t t "" w l ls 10
...
plot\
  "TSG.x12000" u ($2-60):6 t "10 km upstream  " w l ls 1,\
  "TSG.x21000" u ($2-60):6 t "1 km upstream   " w l ls 2,\
  "TSG.x23000" u ($2-60):6 t "1 km downstream " w l ls 3,\
  "TSG.x25000" u ($2-60):6 t "3 km downstream " w l ls 4

set auto y
set out "tmp.png"

plot\
  "TSG.x12000"  u ($2-60):5 t "10 km upstream  " w l ls 1,\
  "TSG.x21000" u ($2-60):5 t "1 km upstream   " w l ls 2,\
  "TSG.x23000" u ($2-60):5 t "1 km downstream " w l ls 3,\
  "TSG.x25000" u ($2-60):5 t "3 km downstream " w l ls 4
...
plot\
  "TSG.x19000"  u (rho($3,$2)):(Q($5,$2)) t "3 km upstream " w l ls 5,\
  "TSG.tab"   u 1:4 t "Equilibrium flow"  w l ls 11
