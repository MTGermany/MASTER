...
set out "rampsOffOn2b_v3d.png"
print "plotting rampsOffOn2b_v3d.png ..."
...
splot  "rampsOffOn2b.dat" u ($1):2:4   w l lt 6

######################
# Spatiotemporal velocity map
######################

set out "rampsOffOn2b_v3d_map_color.png"
print "plotting rampsOffOn2b_v3d_map_color.png ..."
...
splot  "rampsOffOn2b.dat" u ($2):($1):4   w l lt 6

######################
set out "rampsOffOn2b_v3d_map.png"
print "plotting rampsOffOn2b_v3d_map.png ..."
######################

#set palette defined ( 0  "orange",\
#0.20 "yellow", 0.35 "green", 0.55 "blue", 0.70 "#440077", 1 "#440022")
set palette defined ( 0  "#440044", 0.1  "#770055", 0.2 "red", 0.35 "orange",\
0.50 "yellow", 0.65  "#99ff55", 1 "#bbffbb")
splot  "rampsOffOn2b.dat" u ($2):($1):4   w l lt 6
...
set out "rampsOffOn2b_fund.png"
print "plotting rampsOffOn2b_fund.png .."
...
plot\
  "rampsOffOn2b.tab"   u 1:4 t "Fundamentaldiagramm" w l ls 9,\
  "rampsOffOn2b.x15000"  u ($3):5 t "x=15000 m" w linesp ls 12,\
  "rampsOffOn2b.x14000"  u ($3):5 t "x=14000 m" w linesp ls 13,\
  "rampsOffOn2b.x5000"  u ($3):5 t "x=5000 m" w linesp ls 10
...
set out "rampsOffOn2b_v_x16000.png"
print "plotting rampsOffOn2b_v_x16000.png ..."
plot "rampsOffOn2b.x16000" u ($2) : 4 t "x16000" w l ls 1
